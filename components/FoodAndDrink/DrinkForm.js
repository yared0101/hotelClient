...
export const DrinkForm = ({ action = "Create", data = {} }) => {
  const layout = {
    labelCol: {
      span: 6,
    },
  ...
  return (
    <Form
      ...
      size="large"
    >
      <Form.Item name={["drink", "title"]} label="Title">
      ...
      <Form.Item name={["drink", "description"]} label="Description">
